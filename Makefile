...
container:
	...
	DOCKER_BUILDKIT=0 docker build -t ghcr.io/agile-crafts-people/impact_mongodb_api:latest .

push:
	@echo "Pushing Docker container image..."
	@docker push ghcr.io/agile-crafts-people/impact_mongodb_api:latest
	@echo "Pushed: ghcr.io/agile-crafts-people/impact_mongodb_api:latest"
...
delete-package:
	...
	@gh api -X DELETE "/orgs/agile-crafts-people/packages/container/impact_mongodb_api" 2>/dev/null || true
...
open:
	...
	open -a 'Google Chrome' 'http://localhost:9093' || google-chrome 'http://localhost:9093' || xdg-open 'http://localhost:9093'
